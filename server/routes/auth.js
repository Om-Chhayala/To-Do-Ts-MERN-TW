...
var db_1 = require("../db");
var common_1 = require("@100xdevs/common");
var router = express_1.default.Router();
router.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedInput, username, password, user, newUser, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                parsedInput = common_1.signupInput.safeParse(req.body);
                ...
                return [4 /*yield*/, db_1.User.findOne({ username: parsedInput.data.username })];
            case 1:
                user = _a.sent();
